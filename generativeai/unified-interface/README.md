# Knowledge sharing - Unified interface for Generative AI use cases

# Table of Contents (ToC)

- [Knowledge sharing - Unified interface for Generative AI use cases](#knowledge-sharing---unified-interface-for-generative-ai-use-cases)
...
- [Documentation - litellm](https://docs.litellm.ai/docs/)
